...
// Campaign-assigned player Trainer's Class Builder -- mirrors trainers/[id]/build/page.tsx, just under
// this campaign's own path (see [[Give NPCs their own campaign-scoped page]] for why player Trainers
// and NPCs both got their own campaign-scoped routes).
export default async function CampaignTrainerBuildPage({
  params,
  searchParams,
}: {
