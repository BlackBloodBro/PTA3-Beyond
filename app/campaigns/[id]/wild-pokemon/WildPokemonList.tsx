...
import { assignPokemon } from '@/app/pokemon/actions'
import { createLabel, setPokemonLabels } from '@/app/campaigns/[id]/actions'
...
export function WildPokemonList({
  ...
  if (pokemonList.length === 0) {
    return <p className="text-sm text-neutral-500">No wild Pokémon match.</p>
  }
  ...
  return (
    <div className="rounded border p-3">
      ...
      <details className="mt-2">
        <summary className="cursor-pointer text-xs text-neutral-500">Edit labels</summary>
