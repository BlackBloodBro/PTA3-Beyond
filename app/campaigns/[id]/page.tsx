...
import { deleteCampaign, leaveCampaign, removePlayer } from '@/app/campaigns/actions'
  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-6 p-24">
      ...
      <div className="w-full max-w-2xl">
        ...
        {campaign.description && <p className="text-neutral-500">{campaign.description}</p>}
        {isGM && (
      ...
      {isGM && (
        <div className="flex w-full max-w-2xl gap-3">
          <Link href={`/campaigns/${id}/npcs`} className="flex-1 rounded border p-3 hover:bg-neutral-50">
            <span className="text-lg font-semibold">{npcCount} NPCs</span>
            <span className="block text-sm text-neutral-500 underline">View all</span>
          </Link>
          <Link href={`/campaigns/${id}/wild-pokemon`} className="flex-1 rounded border p-3 hover:bg-neutral-50">
      ...
      <div className="flex w-full max-w-2xl flex-col gap-4">
        ...
        {!isGM && (
          <Link href={`/trainers/new?campaignId=${id}`} className="rounded bg-black px-4 py-2 text-center text-white">
