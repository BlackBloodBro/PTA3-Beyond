  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-6 p-24">
      ...
      <div className="flex w-full max-w-2xl flex-col gap-3">
        <Link href="/campaigns" className="rounded border p-4 hover:bg-neutral-50">
        ...
        <Link href="/trainers" className="rounded border p-4 hover:bg-neutral-50">
          <span className="text-lg font-semibold">{trainerCount ?? 0} Trainers</span>
          <span className="block text-sm text-neutral-500 underline">View all</span>
        </Link>
        <Link href="/pokemon" className="rounded border p-4 hover:bg-neutral-50">
