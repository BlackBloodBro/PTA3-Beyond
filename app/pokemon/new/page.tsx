  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-6 p-24">
      ...
      <form method="get" className="flex w-full max-w-sm flex-col gap-2 rounded border p-3 text-sm">
        ...
        <select id="typeId" name="typeId" defaultValue={typeId ?? ''} className="rounded border px-3 py-2">
        ...
        <select id="habitatId" name="habitatId" defaultValue={habitatId ?? ''} className="rounded border px-3 py-2">
      ...
      <p className="w-full max-w-sm text-xs text-neutral-500">{species.length} matching species</p>

      <form action={createPokemon} className="flex w-full max-w-sm flex-col gap-3">
        <SpeciesPicker species={species} />

        <label htmlFor="nickname">Nickname (optional)</label>
        <input id="nickname" name="nickname" type="text" className="rounded border px-3 py-2" />

        <label htmlFor="natureId">Nature (roll a d20 — numbers match the options below)</label>
        <select id="natureId" name="natureId" className="rounded border px-3 py-2" defaultValue="random">
        ...
        <select id="gender" name="gender" className="rounded border px-3 py-2" defaultValue="random">
          <option value="random">Random</option>
        ...
        <select id="campaignId" name="campaignId" className="rounded border px-3 py-2" defaultValue={campaignId ?? ''}>
        ...
        <select id="trainerId" name="trainerId" className="rounded border px-3 py-2" defaultValue="">
