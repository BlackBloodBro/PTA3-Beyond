...
import { deletePokemon } from '@/app/pokemon/actions'
  ...
  return (
    <main className="flex min-h-screen flex-col items-center gap-6 p-24">
      ...
      <div className="flex w-full max-w-2xl items-center justify-between">
        ...
        <Link href="/pokemon/new" className="rounded bg-black px-4 py-2 text-sm text-white">
          + New Pokémon
        </Link>
      </div>
      ...
      <div className="flex w-full max-w-2xl flex-col gap-2">
        {allMyPokemon.length === 0 ? (
          <p className="text-sm text-neutral-500">You don&apos;t have any Pokémon yet.</p>
        ) : (
          allMyPokemon.map((p) => (
